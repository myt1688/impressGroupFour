...
(function() {
    ...
    var e = {
        enterFullScreen: function() {
            $(document).keypress(function(e) {
                e.keyCode === 102 && document.getElementsByTagName("html")[0].webkitRequestFullScreen()
            })
        },
        loadDemo: function(e) {
            if (e.data("demo-loaded")) return;
            var t = e.find(".browser"),
            n = t.find(".address div");
            t.append("<iframe src='" + n.text() + "' frameborder='0'></iframe>");
            var r = t.find("iframe");
            r.load(function() {
                n.text(this.src)
            });
            e.data("demo-loaded", !0)
        },
        loadSrc: function(e) {
            if (e.data("src-loaded")) return;
            $("code[data-src]", e).each(function(e, t) {
                var n = $(t),
                r = n.data("src"),
                i = n.data("language");
                $.get(r,
                function(e) {
                    i === "text" || i === "" ? n.append(e) : Rainbow.color(e, i,
                    function(e) {
                        n.append(e)
                    })
                },
        ...
        resizeBrowser: function() {
            var e;
            document.location.hash === "#/demo-1" ? e = $("#demo-1 .browser") : document.location.hash === "#/demo-2" ? e = $("#demo-2 .browser") : document.location.hash === "#/demo-3" ? e = $("#demo-3 .browser") : document.location.hash === "#/grid-2" ? e = $("#grid-2 .browser") : document.location.hash === "#/grid-4" ? e = $("#grid-4 .browser") : document.location.hash === "#/images-3" ? e = $("#images-3 .browser") : document.location.hash === "#/media-queries-5" ? e = $("#media-queries-5 .browser") : document.location.hash === "#/media-queries-5-2" ? e = $("#media-queries-5-2 .browser") : document.location.hash === "#/media-queries-6" && (e = $("#media-queries-6 .browser"));
            e.width() > 778 ? e.animate({
                width: 778
            },
            2e3, "linear") : e.width() > 490 ? e.animate({
                width: 490
            },
            2e3, "linear") : e.width() > 330 ? e.animate({
                width: 330
            },
            2e3, "linear") : e.animate({
                width: 990
            },
            2e3, "linear")
        }
    ...
    $(function() {
        ...
        window.addEventListener("message", e.resizeBrowser, !1);
        $(".resize").click(e.resizeBrowser);
        e.enterFullScreen()
    })
})();